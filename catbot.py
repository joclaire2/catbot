...
# -------------------------------------------------------
    if (msgText.startswith('hello') or msgText.startswith('hey') or  msgText.startswith('hi')):
        ...
        embed = discord.Embed(title=get_text_face(), description=msg, color=embedColor)
        print(embed)
...
# -------------------------------------------------------
    if (msgText.startswith('c.pic') or msgText.startswith('c.picture')):
        ...
        embed = discord.Embed(title=get_text_face(), description="Here is a cute cat for you~!", color=embedColor)
...
# -------------------------------------------------------
    if (msgText.startswith('c.info') or msgText.startswith('c.botinfo')):
        ...
        embed = discord.Embed(title=get_text_face(), description="catbot is a basic bot with cute mini games where you can collect cats (=ᵔ ﻌ ᵔ=)ﾉ", color=embedColor)
